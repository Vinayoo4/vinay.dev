...
<template>
  <div class="px-6 py-12 md:py-32 max-w-7xl mx-auto min-h-screen flex items-center">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32 w-full">
      ...
      <div class="border border-foreground/10 p-8 md:p-12">
        ...
        <div class="about-element text-xs font-mono uppercase tracking-widest text-foreground/40">Architect / Curator</div>
      </div>
    </div>
  </div>
</template>
