                    ...
                    <div className="p-8">
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {project.tags.map((tag) => (
                          <span key={tag} className="px-3 py-1 rounded-full bg-yellow-500/10 text-yellow-500 text-xs font-semibold">
                            {tag}
                          </span>
                        ))}
                      </div>
                      <div className="flex items-center space-x-4">
                        <Link href={project.link} target="_blank" rel="noopener noreferrer" className="text-yellow-500 hover:underline flex items-center">
